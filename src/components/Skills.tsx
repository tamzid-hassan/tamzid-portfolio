  ...
  return (
    <section id="skills" className="py-32 px-6 relative">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6">The Specs.</h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">Engineered for performance. Built with the industry's most powerful tools.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <GlassCard hoverEffect className="p-8 h-full flex flex-col">
              ...
              <div className="flex flex-wrap gap-2">
                {['ReactJS', 'JavaScript', 'C#', 'Java', 'ASP.NET'].map(skill => (
          ...
          >
            <GlassCard hoverEffect className="p-8 h-full flex flex-col">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-white">Visuals</h3>
          ...
          >
            <GlassCard hoverEffect className="p-8 h-full flex flex-col">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-white">Ecosystem</h3>
